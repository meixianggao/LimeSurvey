    ...
    <?php if($bShowLogo):?>
        <div class="row">
            <div class="jumbotron" id="welcome-jumbotron">
                <img alt="logo" src="/images/welcome.png" id="lime-logo"  class="profile-img-card img-responsive center-block" />
                <p class="hidden-xs custom custom-margin top-25" >这里是 问卷调查 管理员界面。在这里开始构建您的调查。</p>
            </div>
        </div>
    <?php endif;?>
